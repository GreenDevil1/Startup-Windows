...
if %hour% GEQ 8 if %hour% LEQ 14 (
    timeout /t 5
    start "" "C:/Users/green/Documents/Python/Startup/Key_Press/8to14.vbs"
) else if %hour% GEQ 15 if %hour% LEQ 21 (
    timeout /t 5
    start "" "C:/Users/green/Documents/Python/Startup/Key_Press/15to21.vbs"
) else if %hour% GEQ 22 if %hour% LEQ 24 (
    timeout /t 5
    start "" "C:/Users/green/Documents/Python/Startup/Key_Press/22to7.vbs"
